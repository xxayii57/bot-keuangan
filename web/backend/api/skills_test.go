...
func TestHandleListSkills(t *testing.T) {
	...
	oldBuiltin := os.Getenv("INTIMCLAW_BUILTIN_SKILLS")
	if err := os.Setenv("INTIMCLAW_BUILTIN_SKILLS", builtinRoot); err != nil {
		t.Fatalf("Setenv(INTIMCLAW_BUILTIN_SKILLS) error = %v", err)
	}
	defer func() {
		if oldBuiltin == "" {
			_ = os.Unsetenv("INTIMCLAW_BUILTIN_SKILLS")
		} else {
			_ = os.Setenv("INTIMCLAW_BUILTIN_SKILLS", oldBuiltin)
		}
	}()
