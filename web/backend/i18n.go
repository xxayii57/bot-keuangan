...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open IntimClaw console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About IntimClaw",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit IntimClaw",
		Exiting:            "Exiting IntimClaw...",
		DocUrl:             "https://docs.intimclaw.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 IntimClaw 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 IntimClaw",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 IntimClaw",
		Exiting:            "正在退出 IntimClaw...",
		DocUrl:             "https://docs.intimclaw.io/zh-Hans/docs/",
	},
}
