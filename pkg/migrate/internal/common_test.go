...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.intimclaw")
	assert.Equal(t, "/home/user/.intimclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.intimclaw/workspace/file.txt", "/home/user/.intimclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".intimclaw"), result)
}
