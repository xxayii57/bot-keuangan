# IntimClaw Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/intimclaw/internal/gateway/`
...
import (
    "github.com/sipeed/intimclaw/pkg/bus"
    "github.com/sipeed/intimclaw/pkg/config"
)
...
import (
    "github.com/sipeed/intimclaw/pkg/bus"
    "github.com/sipeed/intimclaw/pkg/channels"     // Reference parent package
    "github.com/sipeed/intimclaw/pkg/config"
    "github.com/sipeed/intimclaw/pkg/identity"      // New
    "github.com/sipeed/intimclaw/pkg/media"          // New (if media support needed)
)
```
...
import (
    "github.com/sipeed/intimclaw/pkg/bus"
    "github.com/sipeed/intimclaw/pkg/channels"
    "github.com/sipeed/intimclaw/pkg/config"
)
...
```go
// cmd/intimclaw/internal/gateway/helpers.go
import (
    _ "github.com/sipeed/intimclaw/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/sipeed/intimclaw/pkg/channels/discord"
    _ "github.com/sipeed/intimclaw/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/sipeed/intimclaw/pkg/channels"
    "github.com/sipeed/intimclaw/pkg/config"
    "github.com/sipeed/intimclaw/pkg/identity"
    "github.com/sipeed/intimclaw/pkg/logger"
)
...
// cmd/intimclaw/internal/gateway/helpers.go
import (
    _ "github.com/sipeed/intimclaw/pkg/channels/matrix"
)
```
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom IntimClaw native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
