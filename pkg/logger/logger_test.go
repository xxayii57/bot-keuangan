...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/intimclaw_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("INTIMCLAW_LOG_FILE", tmpFile)
	defer os.Unsetenv("INTIMCLAW_LOG_FILE")
	...
	os.Setenv("INTIMCLAW_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
...
func TestConfigureFromEnvNoEnv(t *testing.T) {
	os.Unsetenv("INTIMCLAW_LOG_FILE")
	ConfigureFromEnv()
}
