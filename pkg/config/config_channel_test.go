...
func TestInitChannelList_TelegramStreamingEnvCompatibility(t *testing.T) {
	t.Setenv("INTIMCLAW_CHANNELS_TELEGRAM_STREAMING_ENABLED", "true")
	t.Setenv("INTIMCLAW_CHANNELS_TELEGRAM_STREAMING_THROTTLE_SECONDS", "3")
	t.Setenv("INTIMCLAW_CHANNELS_TELEGRAM_STREAMING_MIN_GROWTH_CHARS", "120")
