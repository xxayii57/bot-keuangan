...
to authorize your account. On success, the bot token is saved to the intimclaw
...
func printManualWeixinConfig(token, baseURL string) {
	fmt.Println()
	fmt.Println("Add the following to the channels section of your intimclaw config:")
	fmt.Println()
	fmt.Println(`  "weixin": {`)
